...
public class Customer {
    ...
    private int age;
    private final Customer_Flight_info flightInfo; // [Extract Class]
    ...
    Customer(String name, String email, String password, String phone, String address, int age) {
        ...
        this.age = age;
        this.flightInfo = new Customer_Flight_info(); // [Extract Class]
    }
    ...
    public int getTicketsBookedForFlight(Flight selectedFlight) {
        int index = 0;
        for (Flight f : flightsRegisteredByUser) {
            if (f.getFlightNumber().equals(selectedFlight.getFlightNumber())) {
